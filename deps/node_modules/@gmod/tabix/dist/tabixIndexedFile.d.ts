...
export default class TabixIndexedFile {
     ...
     */
    constructor({ path, filehandle, tbiPath, tbiFilehandle, csiPath, csiFilehandle, chunkSizeLimit, yieldLimit, renameRefSeqs, chunkCacheSize, }: {
        path?: string;
     ...
     */
    getLines(refName: string, start: number, end: number, opts: {
        signal?: AbortSignal;
